...
#link("https://github.com/sjfhsjfh/typship")[Typship] is a tool for Typst package development and publishing. Its CLI can install local Typst packages for you. To install a package into the `@local` namespace, run `typship install local` in the package directory.
