...
An example application using Oicana in a React app #link("https://github.com/oicana/oicana-example-typescript-react/")[can be found on GitHub].
...
An example ASP.NET project using the package #link("https://github.com/oicana/oicana-example-csharp-asp-net/")[can be found on GitHub].
...
An example NestJS application using the package #link("https://github.com/oicana/oicana-example-typescript-nestjs/")[can be found on GitHub].
...
An example Axum application using this crate #link("https://github.com/oicana/oicana-example-rust-axum/")[can be found on GitHub].
...
An example FastAPI application using the package #link("https://github.com/oicana/oicana-example-python-fastapi/")[can be found on GitHub].
