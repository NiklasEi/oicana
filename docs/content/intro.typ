...
Oicana offers seamless PDF templating across multiple platforms. Define templates using the modern and open source typesetter #link("https://typst.app")[Typst]. Then specify dynamic inputs and generate high quality PDFs from any environment - whether it's a web browser, server application, or desktop software.
...
- *Powerful Layouting* - Templates can use all of Typst's functionality, including the extensive package ecosystem.
