...
\
#responsive-image("/assets/swagger_response.png", "The 200 response from calling an endpoint in Swagger UI. The response includes a link called \"Download file\".")
